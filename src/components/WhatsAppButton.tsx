...
const WhatsAppButton = () => {
    const handleWhatsAppClick = () => {
        const phoneNumber = "+8801783790931"; // Replace with your actual WhatsApp number
        const message =
            "Hello! I'm interested in your construction equipment rental services. Can you please provide more information?";
